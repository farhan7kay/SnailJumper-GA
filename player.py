...
class Player(pygame.sprite.Sprite):
    ...
    def inputs(self, obstacles, player_x, player_y):
        if(len(obstacles) == 0):
            input_vector = np.array((player_x, player_y, 
                                     player_x, player_y, 
                                     player_x, player_y,
                                     player_x, player_y))
        elif(len(obstacles) >= 1):
            input_vector = np.array((obstacles[0]['x'], obstacles[0]['y'], 
                                     player_x, player_y, 
                                     player_x, player_y,
                                     player_x, player_y)) 
    ...
    def think(self, screen_width, screen_height, obstacles, player_x, player_y):
        ...
        input_vector = self.inputs(obstacles, player_x, player_y)
